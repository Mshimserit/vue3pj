...
const rules = {
  account: [
    ...
    { validator: (rule, value) => validatePhone(value), message: '手机号格式不正确', trigger: 'blur' }
  ],
  password: [
    { required: true, message: '密码不能为空', trigger: 'blur' },
    { validator: (rule, value) => validatePassword(value), message: '密码应为6-14位字母数字组合', trigger: 'blur' }
  ],
  agree: [
    {
