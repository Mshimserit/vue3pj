...
import { addAddressAPI } from '@/apis/order'
...
<template>
  ...
  <!-- 添加地址 -->
  <el-dialog v-model="addFlag" title="添加收货地址" width="500px" @close="resetAddForm">
    <div class="address-form">
      <el-form :model="addForm" :rules="addFormRules" label-width="80px" ref="addFormRef">
        <el-form-item label="收货人" prop="receiver">
          <el-input v-model="addForm.receiver" placeholder="请输入收货人姓名" />
        </el-form-item>
        <el-form-item label="联系方式" prop="contact">
          <el-input v-model="addForm.contact" placeholder="请输入手机号码" />
        </el-form-item>
        <el-form-item label="省市区" prop="fullLocation">
          <el-input v-model="addForm.fullLocation" placeholder="请输入省市区" />
        </el-form-item>
        <el-form-item label="详细地址" prop="address">
          <el-input v-model="addForm.address" type="textarea" placeholder="请输入详细地址" :rows="3" />
        </el-form-item>
        <el-form-item label="默认地址">
          <el-switch v-model="addForm.isDefault" :active-value="0" :inactive-value="1" />
        </el-form-item>
      </el-form>
    </div>
    <template #footer>
      <span class="dialog-footer">
        ...
        <el-button type="primary" @click="submitAddAddress" :loading="submitting">保存</el-button>
      </span>
    </template>
  </el-dialog>
</template>
